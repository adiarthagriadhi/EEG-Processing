...
|---|---|---|---|
| 1 Timestamp & jendela | Fase dari timestamp manual (offset 0); jendela observasi [onset − 0,5 dtk, onset berikut] | ✔ | Gwin dkk. 2011 memakai event gerak dari motion capture untuk mengunci EEG pada fase siklus gerak. Timestamp manual adalah padanan tanpa motion capture. Tidak ada rujukan langsung untuk anotasi manual; dicatat sebagai keterbatasan (reliabilitas anotasi belum diukur, lihat C). |
