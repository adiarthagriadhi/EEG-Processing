...
| M10 | **Power relatif M2b**: (power pita / power 4–30 Hz) dibanding Istirahat, dB | Modifikasi | Power relatif ("Power struggles" 2026); pemisahan komponen aperiodik (Donoghue dkk. 2020) | Total dihitung 4–30 Hz (tanpa delta yang naik karena gerak) dan dinyatakan relatif Istirahat, untuk menghilangkan kenaikan power menyeluruh saat bergerak. M0 (absolut) hanya untuk selisih kontra–ipsi (lateralisasi), karena kenaikan menyeluruh saling meniadakan dalam selisih. *Diputuskan 2026-09-26: M2b untuk semua ukuran tingkat; M0 hanya untuk lateralisasi.* |
